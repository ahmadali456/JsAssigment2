...
document.getElementById("concatenation").onclick = function () {
    ...
    document.getElementById("input-box").innerHTML = '<p>"Any Type of Text in this String" + " " + "M Ahmad Ali" + "!"</p>'
...
document.getElementById("ifStatementNested").onclick = function(){
    ...
    if(userName === "Abdan Bhai"){
        ...
        document.getElementById("output-box").innerHTML = `<span class='text-danger'>${userName} </span> is incorrect user name. <br> correct user name is <span class='text-success'> "Abdan Bhai"</span>`
    }
}
